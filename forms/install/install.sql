...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='附件、文件';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='附件存储器';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='砍价轮播图';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='砍价商品设置';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='砍价设置';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='用户参与砍价所砍的金额';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='签到奖励设置';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='签到设置';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='签到定时任务执行记录表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='签到领取奖励';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='签到插件--用户表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='用户签到提醒记录';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='队列存储';
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='短信、邮箱验证码';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='用户参与红包';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='商品通用信息表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='商城';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='商城商品额外信息表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='秒杀设置';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='模板消息发送记录表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='平台向用户打款';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='分销商信息';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='分销订单';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='分销设置';
...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='用户领取的优惠券关联表（领券中心）';
...
CREATE TABLE `zjhj_bd_core_template_local`
(
    `id`      int(11)                                NOT NULL AUTO_INCREMENT COMMENT '本地模板ID',
    `name`    varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '本地模板名称',
    `pics`    text COLLATE utf8mb4_unicode_ci        NOT NULL COMMENT '本地模板图片',
    `detail`  text COLLATE utf8mb4_unicode_ci        NOT NULL COMMENT '本地模板详情',
    `price`   decimal(10, 2)                         NOT NULL COMMENT '本地模板价格',
    `type`    varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '本地模板类型',
    `version` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '本地模板版本',
    `package` text COLLATE utf8mb4_unicode_ci        NOT NULL COMMENT '本地模板资源包',
    PRIMARY KEY (`id`)
) ENGINE = InnoDB
  AUTO_INCREMENT = 1
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT ='本地模板';
